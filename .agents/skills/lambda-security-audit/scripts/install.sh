#!/usr/bin/env bash
# Installs the lambda-security-audit skill to various AI IDE / CLI tool locations.
...
BEGIN_MARKER="<!-- BEGIN lambda-security-audit skill -->"
END_MARKER="<!-- END lambda-security-audit skill -->"
