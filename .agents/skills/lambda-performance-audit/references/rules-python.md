# Python Lambda Performance Rules

## Official AWS References
- https://docs.aws.amazon.com/lambda/latest/dg/python-handler.html — Handler programming model
- https://docs.aws.amazon.com/lambda/latest/dg/best-practices.html — Lambda best practices
- https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtime-environment.html — Execution environment lifecycle (cold/warm)
- https://boto3.amazonaws.com/v1/documentation/api/latest/guide/configuration.html — boto3 configuration
- https://botocore.amazonaws.com/v1/documentation/api/latest/reference/config.html — botocore Config reference
- https://docs.aws.amazon.com/lambda/latest/dg/python-tracing.html — X-Ray tracing for Python
- https://docs.powertools.aws.dev/lambda/python/latest/ — AWS Lambda Powertools for Python

## Rule: CLIENT_IN_HANDLER [CRITICAL]
...
## Rule: MISSING_CONFIG_IMPORT [HIGH]
...
## Rule: HARDCODED_LOG_LEVEL [MEDIUM]
...
## Rule: MISSING_INVOCATION_LOG [LOW]
